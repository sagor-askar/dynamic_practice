...
class RoleController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        // query to bring the permissions connected to the specific role
        $rolePermission = Permission::join("role_has_permissions", "role_has_permissions.permission_id", "=", "permission_id")->where("role_has_permissions.role_id", $id)->get();
